...
export default function SectionBgGreenary({
  ...
  return (
    <section className="relative w-full overflow-hidden">
      {children}
      <div className="absolute -bottom-[10%] left-0 -z-[1] h-[500px] w-[250px] -translate-x-1/2  md:h-full md:w-[360px]  xl:h-[110%] xl:w-[450px]">
        <BackgroundImage src={bgLeftBottom} alt="background plants" />
      </div>
      <div className="absolute -bottom-[10%] right-0 -z-[1]  h-[500px] w-[250px] translate-x-1/2 md:h-full md:w-[360px]  xl:h-[110%] xl:w-[450px]">
